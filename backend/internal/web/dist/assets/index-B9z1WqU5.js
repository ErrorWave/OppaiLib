 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const zt=Symbol("privateIgnoreAttributeChangesFor");function Re(e){var t;class i extends e{constructor(){super(...arguments),this[t]=new Set}attributeChangedCallback(o,r,n){if(!ui(o)){super.attributeChangedCallback(o,r,n);return}if(this[zt].has(o))return;this[zt].add(o),this.removeAttribute(o),this[zt].delete(o);const d=zi(o);n===null?delete this.dataset[d]:this.dataset[d]=n,this.requestUpdate(zi(o),r)}getAttribute(o){return ui(o)?super.getAttribute(Si(o)):super.getAttribute(o)}removeAttribute(o){super.removeAttribute(o),ui(o)&&(super.removeAttribute(Si(o)),this.requestUpdate())}}return t=zt,ns(i),i}function ns(e){for(const t of Co){const i=Io(t),a=Si(i),o=zi(i);e.createProperty(t,{attribute:i,noAccessor:!0}),e.createProperty(Symbol(a),{attribute:a,noAccessor:!0}),Object.defineProperty(e.prototype,t,{configurable:!0,enumerable:!0,get(){return this.dataset[o]??null},set(r){const n=this.dataset[o]??null;r!==n&&(r===null?delete this.dataset[o]:this.dataset[o]=r,this.requestUpdate(t,n))}})}}function Si(e){return`data-${e}`}function zi(e){return e.replace(/-\w/,t=>t[1].toUpperCase())}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function ls(e){const t=new MouseEvent("click",{bubbles:!0});return e.dispatchEvent(t),t}function ds(e){return e.currentTarget!==e.target||e.composedPath()[0]!==e.target||e.target.disabled?!1:!cs(e)}function cs(e){const t=Ei;return t&&(e.preventDefault(),e.stopImmediatePropagation()),ps(),t}let Ei=!1;async function ps(){Ei=!0,await null,Ei=!1}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ss=e=>e.strings===void 0,zs={},Eo=(e,t=zs)=>e._$AH=t;/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ja=ai(class extends oi{constructor(e){if(super(e),e.type!==Le.PROPERTY&&e.type!==Le.ATTRIBUTE&&e.type!==Le.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ss(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===he||t===l)return t;const i=e.element,a=e.name;if(e.type===Le.PROPERTY){if(t===i[a])return he}else if(e.type===Le.BOOLEAN_ATTRIBUTE){if(!!t===i.hasAttribute(a))return he}else if(e.type===Le.ATTRIBUTE&&i.getAttribute(a)===t+"")return he;return Eo(e),t}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ao="important",Es=" !"+Ao,Ga=ai(class extends oi{constructor(e){var t;if(super(e),e.type!==Le.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return a==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const a of this.ft)t[a]==null&&(this.ft.delete(a),a.includes("-")?i.removeProperty(a):i[a]=null);for(const a in t){const o=t[a];if(o!=null){this.ft.add(a);const r=typeof o=="string"&&o.endsWith(Es);a.includes("-")||r?i.setProperty(a,r?o.slice(0,-11):o,r?Ao:""):i[a]=o}}return he}});/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Mi=Symbol("createValidator"),Ri=Symbol("getValidityAnchor"),fi=Symbol("privateValidator"),$e=Symbol("privateSyncValidity"),Et=Symbol("privateCustomValidationMessage");function Ls(e){var t;class i extends e{constructor(){super(...arguments),this[t]=""}get validity(){return this[$e](),this[oe].validity}get validationMessage(){return this[$e](),this[oe].validationMessage}get willValidate(){return this[$e](),this[oe].willValidate}checkValidity(){return this[$e](),this[oe].checkValidity()}reportValidity(){return this[$e](),this[oe].reportValidity()}setCustomValidity(o){this[Et]=o,this[$e]()}requestUpdate(o,r,n){super.requestUpdate(o,r,n),this[$e]()}firstUpdated(o){super.firstUpdated(o),this[$e]()}[(t=Et,$e)](){this[fi]||(this[fi]=this[Mi]());const{validity:o,validationMessage:r}=this[fi].getValidity(),n=!!this[Et],d=this[Et]||r;this[oe].setValidity({...o,customError:n},d,this[Ri]()??void 0)}[Mi](){throw new Error("Implement [createValidator]")}[Ri](){throw new Error("Implement [getValidityAnchor]")}}return i}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let Ui=class extends js{};Ui.styles=[zo,Gs];Ui=h([I("md-outlined-field")],Ui);/**
 * @license
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const tn=Re(C);class ze extends tn{get rippleDisabled(){return this.disabled||this.softDisabled}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.alwaysFocusable=!1,this.label="",this.hasIcon=!1,this.addEventListener("click",this.handleClick.bind(this))}focus(t){this.disabled&&!this.alwaysFocusable||super.focus(t)}render(){return s`
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class It extends ze{constructor(){super(...arguments),this.elevated=!1,this.href="",this.download="",this.target=""}get primaryId(){return this.href?"link":"button"}get rippleDisabled(){return!this.href&&(this.disabled||this.softDisabled)}getContainerClasses(){return{...super.getContainerClasses(),disabled:!this.href&&(this.disabled||this.softDisabled),elevated:this.elevated,link:!!this.href}}renderPrimaryAction(t){const{ariaLabel:i}=this;return this.href?s`
        <a
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function Ro(e,t=Ee){const i=Fo(e,t);return i&&(i.tabIndex=0,i.focus()),i}function No(e,t=Ee){const i=vn(e,t);return i&&(i.tabIndex=0,i.focus()),i}function vi(e,t=Ee){for(let i=0;i<e.length;i++){const a=e[i];if(a.tabIndex===0&&t(a))return{item:a,index:i}}return null}function Fo(e,t=Ee){for(const i of e)if(t(i))return i;return null}function vn(e,t=Ee){for(let i=e.length-1;i>=0;i--){const a=e[i];if(t(a))return a}return null}function bn(e,t,i=Ee,a=!0){for(let o=1;o<e.length;o++){const r=(o+t)%e.length;if(r<t&&!a)return null;const n=e[r];if(i(n))return n}return e[t]?e[t]:null}function yn(e,t,i=Ee,a=!0){for(let o=1;o<e.length;o++){const r=(t-o+e.length)%e.length;if(r>t&&!a)return null;const n=e[r];if(i(n))return n}return e[t]?e[t]:null}function Wa(e,t,i=Ee,a=!0){if(t){const o=bn(e,t.index,i,a);return o&&(o.tabIndex=0,o.focus()),o}else return Ro(e,i)}function qa(e,t,i=Ee,a=!0){if(t){const o=yn(e,t.index,i,a);return o&&(o.tabIndex=0,o.focus()),o}else return No(e,i)}function xn(){return new Event("request-activation",{bubbles:!0,composed:!0})}function Ee(e){return!e.disabled}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Bo=Symbol("animateIndicator"),zn=Sn(C);class we extends zn{get selected(){return this.active}set selected(t){this.active=t}constructor(){super(),this.isTab=!0,this.active=!1,this.hasIcon=!1,this.iconOnly=!1,this.fullWidthIndicator=!1,this.internals=this.attachInternals(),this.internals.role="tab",this.addEventListener("keydown",this.handleKeydown.bind(this))}render(){const t=s`<div class="indicator"></div>`;return s`<div
      class="button"
      role="presentation"
